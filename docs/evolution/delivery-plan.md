...
**Актуальний порядок та межі поставок:** [280 узгоджених вимог](implementation-order.md) і [перші релізи](first-releases.md). Вони уточнюють sequencing та allocation цього концептуального плану; canonical IDs, dependencies й старі gates збережені. У разі різної деталізації обсягу релізу користуватися first-releases.
