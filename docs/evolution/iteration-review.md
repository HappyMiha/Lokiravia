...
## D01 — приватність джерел, 2026-09-10
...
## Збереження двомовного рішення, 2026-09-10

Власник погодив міжнародну подачу з українською робочою мовою та повноцінною англійською документацією. [Мовна політика](language-policy.md) і її [English version](language-policy.en.md) зберігають рішення, послідовність перекладу та правила синхронності. Попередні українські матеріали збережено. Повного перекладу портфеля або готового translation checker ще немає; ця поставка їх не заявляє. Книжки й приватні матеріали виключені з публікації.


## Публікація на головній гілці та спрощення розробки, 2026-09-10

Власник попросив зробити портфель видимим із головних сторінок репозиторіїв і видалити прив’язаний до пристроїв процес розробки. Підготовлено звичайні pull requests у main: Core50 і Lokiravia23. Вилучено окремі інструменти реєстрації/резервування, їхні hooks, CI та інструкції; правила внесення змін і PR template стали незалежними від пристроїв. Product runtime, agent/worker admission, виконувальні права та окремий controller тестового deployment збережені.

Корисну перевірку активних беклогів перенесено в нейтральний validate_backlog і CI Planning validation. Збережено негативні перевірки DAG, hierarchy, release gates та Markdown/JSON acceptance; додано ізольовану CLI-перевірку без Git. Metadata delivery notes GC043/CLD054 узгоджено з новим процесом; IDs, dependencies, product acceptance criteria не змінені. Source pins/digests спільного порядку та Cloud planning baseline оновлено до точних commit identities. Саме видалення старої інструкції не створює нових runtime можливостей або product acceptance.
