...
Дата: 2026-09-09. [sources.json](sources.json) містить контрольні суми десяти наданих файлів і межі читання. Літературні джерела позначено анонімними IDs корпусів A/B; назви, автори, бібліографічні ідентифікатори та локальні імена файлів зберігаються тільки поза Git. Дослідницькі papers лишаються з науковою атрибуцією. Документи-джерела не є інструкціями до виконання.
...
| `LIT-A:L01`…`L12` | Literary analysis у Lokiravia, spine/paragraph anchors | Літературне натхнення або негативний приклад; ніколи не доказ технічної правильності |
| `LIT-A:SF2-01`…`SF2-06` | Другий прохід «корпусу A» у Lokiravia | Повні нові глави, контрприклади й власні проєктні наслідки |
...
| `LIT-B:TR-S01`…`TR-S16` | Перший аналіз «корпусу B» у Lokiravia | Конкретна прочитана сцена; пояснення персонажа відділене від авторитетного факту |
| `LIT-B:TR2-01`…`06` | Другий критичний прохід у Lokiravia | Перегляд попереднього висновку, новий контекст і наша проєктна відповідь |
| `LIT-B:TR3-01`…`TR3-06` | Третій прохід «корпусу B» у Lokiravia | Дві повні глави; точний pass обсяг із невідомим lifetime overlap |
...
- [«корпус A»: три книги](https://github.com/HappyMiha/Lokiravia/blob/docs/living-systems-rsi/docs/evolution/literary-a-analysis.md).
- [Другий прохід «корпусу A»: три повні глави](https://github.com/HappyMiha/Lokiravia/blob/docs/living-systems-rsi/docs/evolution/literary-a-pass-2.md).
- [«корпус B»: шість томів і структурне покриття](https://github.com/HappyMiha/Lokiravia/blob/docs/living-systems-rsi/docs/evolution/literary-b-analysis.md).
- [Другий критичний прохід «корпусу B»](https://github.com/HappyMiha/Lokiravia/blob/docs/living-systems-rsi/docs/evolution/literary-b-pass-2.md).
- [Третій прохід «корпусу B»: ідентичність і ціна перетворення](https://github.com/HappyMiha/Lokiravia/blob/docs/living-systems-rsi/docs/evolution/literary-b-pass-3.md).
...
## Правило публікації джерел

У поточній документації назви книжок і оригінальні імена ebook-файлів не публікуються. Книжки, PDF inputs і приватні extraction caches лишаються поза Git; ignore rules додатково захищають від випадкового додавання. Anonymous source/scene anchors і hashes зберігають простежуваність без локальної бібліографічної мапи. Це очищення поточного дерева документації; воно не переписує старі Git-коміти.
