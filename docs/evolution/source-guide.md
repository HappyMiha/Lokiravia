...
| `RSI-DGM`, `RSI-RQGM`, `RSI-AEVOLVE`, `RSI-SOUNDNESS` | Розділ першоджерел того самого документа, URL у sources.json | Незалежно звірені metadata/abstract; повне відтворення чи читання всіх методів не заявлене |
...
«Бігаючий сейф»: проіндексовано три EPUB у порядку spine, 7,585 абзаців / 1,174,753 символи. Контрольований перший прохід — 629 повних абзаців / 91,564 символи, 7.79% за цим виміром. Тематичні сцени, перелік мотивів і обмеження наведені в записці. Індексація не дорівнює читанню.
